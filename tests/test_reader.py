...
class ReaderTest(unittest.TestCase):
    def setUp(self):
        self.tsdb_file = os.path.join(
            os.path.dirname(__file__), "test_data", "sample.tsdb"
        )
        self.tsdb_file_with_missing = os.path.join(
            os.path.dirname(__file__), "test_data", "sample_missing.tsdb"
        )
        self.empty_tsdb_file = os.path.join(
            os.path.dirname(__file__), "test_data", "empty.tsdb"
        )
