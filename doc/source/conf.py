...
MOCK_MODULES = ["numpy", "pandas", "tables", "matplotlib"]

for mod_name in MOCK_MODULES:
    sys.modules[mod_name] = mock.Mock()

os.system(
    "sphinx-apidoc -T -f -o ./api ../../phildb ../../phildb/dbstructures.py ../../phildb/test*"
)
...
latex_documents = [
    ("index", "PhilDB.tex", "PhilDB Documentation", "Andrew MacDonald", "manual")
]
...
man_pages = [("index", "phildb", "PhilDB Documentation", ["Andrew MacDonald"], 1)]
